# ASP.NET Core API with Automapper

This project will walk your through creating standard API servies for a .NET Core API project.  In addition, you will also setup Automapper so that your exposed objects to future clients would be different that your data access models.
